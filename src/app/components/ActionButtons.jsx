    ...
    <div className="fixed bottom-0 left-0 w-full bg-[rgba(244,244,242,0.8)] p-4 shadow-lg">
      <div className="grid grid-cols-4 gap-4 text-center">
        ...
        <Link href="/box" className="flex flex-col items-center justify-center hover:text-[#C0B8AE] transition">
          ...
          <span className="mt-2 text-sm sm:text-lg">しまう</span>
        </Link>
        <Link href="/medal" className="flex flex-col items-center justify-center hover:text-[#C0B8AE] transition">
          <FaMedal className="text-3xl" />
          <span className="mt-2 text-sm sm:text-lg">勝つ</span>
        </Link>
        <Link href="/personal" className="flex flex-col items-center justify-center hover:text-[#C0B8AE] transition">
          <FaLightbulb className="text-3xl" />
          <span className="mt-2 text-sm sm:text-lg">変換</span>
        </Link>
      </div>
    </div>
  );
